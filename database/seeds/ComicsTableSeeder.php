    ...
    public function run()
        {
            ...
            foreach($ComicList as $ele){
                $newComic = new Comic();
                $newComic->title=$ele['title'];
                $newComic->description=$ele['description'];
                $newComic->thumb=$ele['thumb'];
                $newComic->price=$ele['price'];
                $newComic->series=$ele['series'];
                $newComic->sale_date=$ele['sale_date'];
                $newComic->type=$ele['type'];
